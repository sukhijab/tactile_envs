...
def main(_):
    ...
    f = open("tactile_envs/assets/exploration/right_pad_collisions.xml", "w")
    f.write("<mujoco>\n")
    for i in range(dy):
        ...
        for j in range(dx):
            ...
            xml_string = "<geom class=\"pad\" pos=\"{} -0.0026 {}\" size=\"{} 0.004 {}\" rgba=\"{} {} {} 1\" name=\"rpad_geom{}\"/>".format(
                pos_x, pos_y, size_x, size_y, rgb, rgb, rgb, i * dx + j)

            f.write(xml_string + '\n')
    f.write("</mujoco>")
    f.close()

    f = open("tactile_envs/assets/exploration/left_pad_collisions.xml", "w")
    f.write("<mujoco>\n")
    for i in range(dy):
        pos_y = size_y + 2 * size_y * i
        for j in range(dx):
            ...
            xml_string = "<geom class=\"pad\" pos=\"{} -0.0026 {}\" size=\"{} 0.004 {}\" rgba=\"{} {} {} 1\" name=\"lpad_geom{}\"/>".format(
                pos_x, pos_y, size_x, size_y, rgb, rgb, rgb, i * dx + j)
    ...
    """.format(dx, dy, dx, dy)
    f = open("tactile_envs/assets/exploration/touch_sensors.xml", "w")
